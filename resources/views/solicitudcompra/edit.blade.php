									...
									<div class="table-responsive">
										<table class="table table-bordered table-hover" id="education_fields2">
											...
											@foreach($solicitudcompra->productossolicitudcompra as $prodsolcompra)
												...
												@endif
												<tr>
													<td id="ver_num_producto"{{$loop->index + 1}}>{{$loop->index + 1}}</td>								
													<td class="nopadding" >
														<div class="form-group">
													...
													<td class="nopadding" >
														<div class="form-group">
															<input type="number" class="form-control" id="cantidad{{$loop->index + 1}}" name="cantidad{{$loop->index + 1}}" required="required" value="{{$prodsolcompra->cant_sol_prd}}" placeholder="Cantidad">
														</div>
													</td>
													<td>
	...
	<script>
		...
		function education_fields2(productos) {
			...
			var text = '<tr><td id="ver_num_producto'+(producto)+'">' + (producto) +'</td>'+
				...
				//Cantidad
				'<td class="nopadding" >'+
					'<div class="form-group"><input type="number" required="required" class="form-control" required="required" id="cantidad'+(producto)+'" name="cantidad'+(producto)+'" value="" placeholder="Cantidad"/></div>'+
				'</td>'+				
				//Disponible
				'<td class="nopadding" >'+
					'<div class="form-group"><input type="text" class="form-control" id="disponible'+(producto)+'" name="disponible'+(producto)+'" disabled/></div>'+
