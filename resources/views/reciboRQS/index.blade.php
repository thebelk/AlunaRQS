...
@section('x_content')
  <div class="x_panel">
	    <div class="x_title"> 
			...
			@permission('ver-descargar-todo-recibir-rqs')					
				<div class=" col-md-2 col-sm-2 col-xs-6 right">
						<a  class="btn btn-primary  left" role="button"><i class="glyphicon glyphicon-cloud-download" aria-hidden="true"></i>&nbsp&nbsp Descargar </a>
				</div>
			@endpermission
					...
					@foreach($requisiciones as $requisicion)					
						@if($requisicion->registrohistoricorequisicion->first()->user->id == Auth::user()->id)
							...
							<tr>
								...
								<td>
								@permission('ver-editar-recibir-rqs')
